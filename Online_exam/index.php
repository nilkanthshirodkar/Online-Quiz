...
echo "<h1 class='style8' align=center>Wel come to Online Exam</h1>";
  ...
  <tr>
    <td width="7%" height="65" valign="bottom"><img src="image/HLPBUTT2.JPG" width="50" height="50" align="middle"></td>
    <td width="93%" valign="bottom" bordercolor="#0000FF"> <a href="group.php" class="style4">Group Test </a></td>
  </tr>
...
<p align="left" class="style5">&nbsp;</p>
    ...
    <td valign="top"><form name="form1" method="post" action="">
      ...
      <div align="center">
        <p class="style5"><img src="images/conf.jpg" width="250" height="350">          </p>
        </div>
    </form></td>
  </tr>
</table>
